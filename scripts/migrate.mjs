...
const {
  NEXT_PUBLIC_SANITY_PROJECT_ID="hcxu5k9a", // Sanity project ID
  NEXT_PUBLIC_SANITY_DATASET="production", // Sanity dataset (e.g., "production")
  NEXT_PUBLIC_SANITY_AUTH_TOKEN="skhWZysw10kH1zpRibE8GgpxTCNz42YE70O3kzA7l8JjlZ67Jr8kAz1m3pgfmLVk2lgyhevUFVT0LAxfmKduGWNh1mFr9vq40B29mowxxirmbpOsnGJZ9IK3oIMLCaGbA9jKXnYOMilpkPecjq6eVt3O3NU3cWBUSHusRdtAc5SxrLKLunlh", // Sanity API token
...
const targetClient = createClient({
  projectId: "hcxu5k9a", // Your Sanity project ID
  ...
  token: "skhWZysw10kH1zpRibE8GgpxTCNz42YE70O3kzA7l8JjlZ67Jr8kAz1m3pgfmLVk2lgyhevUFVT0LAxfmKduGWNh1mFr9vq40B29mowxxirmbpOsnGJZ9IK3oIMLCaGbA9jKXnYOMilpkPecjq6eVt3O3NU3cWBUSHusRdtAc5SxrLKLunlh", // API token for authentication
});
